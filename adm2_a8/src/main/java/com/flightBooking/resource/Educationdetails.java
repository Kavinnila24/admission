 ...
 */
@Component
 public class Educationdetails extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("educationdetails");
	...
	static {
		...
		metaData.setTableName("educationdetails");

		metaData.setCluster("traveler_db");
	}

	public Educationdetails() {this.setId(Util.getUniqueId());}
	public Educationdetails(String id) {this.setId(id);}

	public Educationdetails(Educationdetails obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return EducationdetailsResult.class;};
	public  Class<?> getMessageClass() {return EducationdetailsMessage.class;};
	public  Class<?> getHelperClass() {return EducationdetailsHelper.class;};
	public  Class<?> getServiceClass() {return EducationdetailsService.class;};
}