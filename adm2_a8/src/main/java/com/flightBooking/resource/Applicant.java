 ...
 */
@Component
 public class Applicant extends BaseResource {
	...
	public static String FIELD_ABC = "abc";
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("applicant");
	...
	static {
		...
		Field fullnameadField = new Field("fullnamead", "String");
		fullnameadField.setRequired(true);
		metaData.addField(fullnameadField);

		Field mobileField = new Field("mobile", "String");
		...
		Field abcField = new Field("abc", "String");
		abcField.setRequired(true);
		metaData.addField(abcField);
		...
		Field photoField = new Field("photo", "String");
		photoField.setRequired(true);
		metaData.addField(photoField);
		...
		metaData.setTableName("applicant");

		metaData.setCluster("traveler_db");
	}

	public Applicant() {this.setId(Util.getUniqueId());}
	public Applicant(String id) {this.setId(id);}
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		if(fullname12Obj != null)
			fullname12 = fullname12Obj.toString();

		Object fullnameadObj = map.get("fullnamead");
		if(fullnameadObj != null)
			fullnamead = fullnameadObj.toString();
	...
	public String getFullname12Ex() {
		return fullname12 != null ? fullname12 : "";
	}

	public void setFullname12(String fullname12) {
		this.fullname12 = fullname12;
	}

	public void unSetFullname12() {
		this.fullname12 = null;
	}

	public boolean validateFullname12(boolean add) throws ApplicationException {
		if(add && fullname12 == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[fullname12]");
		return fullname12 != null;
	}
	...
	public String getFullnameadEx() {
		return fullnamead != null ? fullnamead : "";
	}
	...
	public void unSetFullnamead() {
		this.fullnamead = null;
	}

	public boolean validateFullnamead(boolean add) throws ApplicationException {
		if(add && fullnamead == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[fullnamead]");
		return fullnamead != null;
	}
	...
	public void unSetAbc() {
		this.abc = null;
	}

	public boolean validateAbc(boolean add) throws ApplicationException {
		if(add && abc == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[abc]");
		return abc != null;
	}
	...
	public boolean validatePhoto(boolean add) throws ApplicationException {
		if(add && photo == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[photo]");
		return photo != null;
	}
	...
	public  Class<?> getResultClass() {return ApplicantResult.class;};
	public  Class<?> getMessageClass() {return ApplicantMessage.class;};
	public  Class<?> getHelperClass() {return ApplicantHelper.class;};
	public  Class<?> getServiceClass() {return ApplicantService.class;};
}