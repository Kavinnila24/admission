 ...
 */
@Component
 public class Guardian extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("guardian");
	...
	static {
		...
		metaData.setTableName("guardian");

		metaData.setCluster("traveler_db");
	}

	public Guardian() {this.setId(Util.getUniqueId());}
	public Guardian(String id) {this.setId(id);}

	public Guardian(Guardian obj) {
		this.id = obj.id;
	...
	public boolean validateRelation(boolean add) throws ApplicationException {
		if(add && relation == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[relation]");
	...
	public  Class<?> getResultClass() {return GuardianResult.class;};
	public  Class<?> getMessageClass() {return GuardianMessage.class;};
	public  Class<?> getHelperClass() {return GuardianHelper.class;};
	public  Class<?> getServiceClass() {return GuardianService.class;};
}