 ...
 */
@Component
 public class Permaddress extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("permaddress");
	...
	static {
		...
		metaData.setTableName("permaddress");

		metaData.setCluster("traveler_db");
	}

	public Permaddress() {this.setId(Util.getUniqueId());}
	public Permaddress(String id) {this.setId(id);}

	public Permaddress(Permaddress obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return PermaddressResult.class;};
	public  Class<?> getMessageClass() {return PermaddressMessage.class;};
	public  Class<?> getHelperClass() {return PermaddressHelper.class;};
	public  Class<?> getServiceClass() {return PermaddressService.class;};
}