...
//                .httpBasic(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/register","/api/auth/login", "/api/auth/callback", "/api/auth/logout","/api/auth/addUser","/api/v1/role_resource","/api/auth/add-client-role","/api/auth/assign-client-role","/api/auth/user_resource_role","/api/role_resource_permission","/api/auth/add_user","/api/generateApp","/api/resource_role","/api/auth/user_role_mapping","/api/getAllResourceMetaData","/api/GetAllResource","/api/getAllResourceMetaData/{resource}","/api/auth/validate-admin","/api/auth/test-role").permitAll()
        ...
        System.out.println("Hi authenticated");
        return http.build();
    }
