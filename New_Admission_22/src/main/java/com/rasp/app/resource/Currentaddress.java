 ...
 */
@Component
 public class Currentaddress extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("currentaddress");
	...
	static {
		...
		metaData.addField(line1Field);

		Field line2Field = new Field("line2", "String");
		line2Field.setRequired(true);
		metaData.addField(line2Field);
		...
		metaData.setTableName("currentaddress");

		metaData.setCluster("traveler_db");
	}

	public Currentaddress() {this.setId(Util.getUniqueId());}
	public Currentaddress(String id) {this.setId(id);}

	public Currentaddress(Currentaddress obj) {
		this.id = obj.id;
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(validateCity(add))
			map.put("city", city);
		if(validateState(add))
			map.put("state", state);
		if(validateCountry(add))
			map.put("country", country);
		if(validatePincode(add))
			map.put("pincode", pincode);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		if(line1Obj != null)
			line1 = line1Obj.toString();

		Object line2Obj = map.get("line2");
		if(line2Obj != null)
			line2 = line2Obj.toString();
	...
	public boolean validateLine1(boolean add) throws ApplicationException {
		if(add && line1 == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[line1]");
		return line1 != null;
	}
	...
	public boolean validateLine2(boolean add) throws ApplicationException {
		if(add && line2 == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[line2]");
		return line2 != null;
	}
	...
	public boolean validateCity(boolean add) throws ApplicationException {
		if(add && city == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[city]");
		return city != null;
	}
	...
	public boolean validateState(boolean add) throws ApplicationException {
		if(add && state == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[state]");
		return state != null;
	}
	...
	public boolean validateCountry(boolean add) throws ApplicationException {
		if(add && country == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[country]");
		return country != null;
	}
	...
	public boolean validatePincode(boolean add) throws ApplicationException {
		if(add && pincode == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[pincode]");
		return pincode != null;
	}
	...
	public  Class<?> getResultClass() {return CurrentaddressResult.class;};
	public  Class<?> getMessageClass() {return CurrentaddressMessage.class;};
	public  Class<?> getHelperClass() {return CurrentaddressHelper.class;};
	public  Class<?> getServiceClass() {return CurrentaddressService.class;};
}