 ...
 */
@Component
 public class Examdetails extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("examdetails");
	...
	static {
		...
		metaData.setTableName("examdetails");

		metaData.setCluster("traveler_db");
	}

	public Examdetails() {this.setId(Util.getUniqueId());}
	public Examdetails(String id) {this.setId(id);}

	public Examdetails(Examdetails obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return ExamdetailsResult.class;};
	public  Class<?> getMessageClass() {return ExamdetailsMessage.class;};
	public  Class<?> getHelperClass() {return ExamdetailsHelper.class;};
	public  Class<?> getServiceClass() {return ExamdetailsService.class;};
}