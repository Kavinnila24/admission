 ...
 */
@Component
 public class Olympiad extends BaseResource {
	...
	public static String FIELD_NO = "no";
	public static String FIELD_PROOF = "proof";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("olympiad");
	...
	static {
		...
		Field noField = new Field("no", "String");
		noField.setRequired(true);
		metaData.addField(noField);

		Field proofField = new Field("proof", "String");
		proofField.setRequired(true);
		metaData.addField(proofField);
		...
		metaData.setTableName("olympiad");

		metaData.setCluster("traveler_db");
	}

	public Olympiad() {this.setId(Util.getUniqueId());}
	public Olympiad(String id) {this.setId(id);}

	public Olympiad(Olympiad obj) {
		this.id = obj.id;
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object noObj = map.get("no");
		if(noObj != null)
			no = noObj.toString();

		Object proofObj = map.get("proof");
		if(proofObj != null)
			proof = proofObj.toString();
	...
	public boolean validateNo(boolean add) throws ApplicationException {
		if(add && no == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[no]");
		return no != null;
	}
	...
	public boolean validateProof(boolean add) throws ApplicationException {
		if(add && proof == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[proof]");
		return proof != null;
	}
	...
	public  Class<?> getResultClass() {return OlympiadResult.class;};
	public  Class<?> getMessageClass() {return OlympiadMessage.class;};
	public  Class<?> getHelperClass() {return OlympiadHelper.class;};
	public  Class<?> getServiceClass() {return OlympiadService.class;};
}