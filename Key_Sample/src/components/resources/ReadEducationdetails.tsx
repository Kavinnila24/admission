...
const ReadEducationdetails = () => {
    ...
    const { data: dataRes, isLoading: isLoadingDataRes, error: errorDataRes } = useQuery({
        queryKey: ['resourceData', 'educationdetails', userId],
        queryFn: async () => {
            ...
            const response = await fetch(
                `${apiConfig.getResourceUrl('educationdetails')}?` + params.toString(),
                {
                    method: "GET",
                    headers: {
    ...
    const { data: dataResMeta, isLoading: isLoadingDataResMeta, error: errorDataResMeta } = useQuery({
        queryKey: ['resourceMetaData', 'Educationdetails'],
        queryFn: async () => {
            const response = await fetch(
                `${apiConfig.getResourceMetaDataUrl('Educationdetails')}?`,
                {
                    method: "GET",
...
export default ReadEducationdetails;