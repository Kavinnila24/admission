...
const ReadOlympiad = () => {
    ...
    const { data: dataRes, isLoading: isLoadingDataRes, error: errorDataRes } = useQuery({
        queryKey: ['resourceData', 'olympiad', userId],
        queryFn: async () => {
            ...
            const response = await fetch(
                `${apiConfig.getResourceUrl('olympiad')}?` + params.toString(),
                {
                    method: "GET",
    ...
    const { data: dataResMeta, isLoading: isLoadingDataResMeta, error: errorDataResMeta } = useQuery({
        queryKey: ['resourceMetaData', 'Olympiad'],
        queryFn: async () => {
            const response = await fetch(
                `${apiConfig.getResourceMetaDataUrl('Olympiad')}?`,
                {
                    method: "GET",
