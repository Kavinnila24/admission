...
const ReadPermaddress = () => {
    ...
    const { data: dataRes, isLoading: isLoadingDataRes, error: errorDataRes } = useQuery({
        queryKey: ['resourceData', 'permaddress', userId],
        queryFn: async () => {
            ...
            const response = await fetch(
                `${apiConfig.getResourceUrl('permaddress')}?` + params.toString(),
                {
                    method: "GET",
                    headers: {
    ...
    const { data: dataResMeta, isLoading: isLoadingDataResMeta, error: errorDataResMeta } = useQuery({
        queryKey: ['resourceMetaData', 'Permaddress'],
        queryFn: async () => {
            const response = await fetch(
                `${apiConfig.getResourceMetaDataUrl('Permaddress')}?`,
                {
                    method: "GET",
...
export default ReadPermaddress;