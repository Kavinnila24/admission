...
const CreateEducationdetails = () => {
    ...
    const apiUrl = apiConfig.getResourceUrl("educationdetails");
    const metadataUrl = apiConfig.getResourceMetaDataUrl("Educationdetails");
    ...
    const { data: metaData, isLoading, error } = useQuery({
        queryKey: ['resMetaData', 'Educationdetails'],
        queryFn: async () => {
    ...
    return (
        <div>
            <div>
                <h2 className='mt-5 fs-4'>12th or Equivalent</h2>
                <hr />
            </div>
