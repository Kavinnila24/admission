...
const CreateGuardian = () => {
    ...
    const apiUrl = apiConfig.getResourceUrl("guardian");
    const metadataUrl = apiConfig.getResourceMetaDataUrl("Guardian");
    ...
    return (
        <div>
            <div>
                <h3 className='mt-5 fs-4'> Parent-Guardian Details</h3>
                <hr />
            </div>
