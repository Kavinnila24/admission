...
const CreateOlympiad = () => {
    ...
    const apiUrl = apiConfig.getResourceUrl("olympiad");
    const metadataUrl = apiConfig.getResourceMetaDataUrl("Olympiad");
    ...
    return (
        <div>
            <div>
                <h2 className='mt-5 fs-4'>Olympiad Exam</h2>
                <hr />
            </div>
                                ...
                                <div key={index} className="col-md-6 mb-2">
                                    ...
                                    {field.name === 'proof' ? (
                                        <div className="mb-3">
                                            ...
                                            <GridFSImageUploader value={dataToSave[field.name] || ""} onChange={(fileId: string) => setDataToSave((prev: any) => ({ ...prev, [field.name]: fileId }))}  required={field.required} allowedTypes={["image/jpeg", "image/jpg", "image/png", "image/webp", "application/pdf"]} placeholder="Upload proof document" />
                                        </div>
                                    ) : field.foreign ? (
                                        <>
